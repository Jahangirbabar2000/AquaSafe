...
function App(props) {
    ...
    const leafletContainerStyles = {
        marginLeft: "5vh", width: "50vh", height: "50vh"
    };
    ...
    return (
        ...
        <Grid container spacing={2} p={12} pt={0} pb={5} >
            ...
            <Grid item xs={9} > {/* Right big section*/}
                <h3>TOP PARAMETERS</h3>
                <Grid container justifyContent="space-around" sm={12}> {/* PARAMETERS */}
                    <Parameters parameterName="Temperature" value={28 + "°C"} />
                    <Parameters parameterName="Conductivity" value={dummyData[1].Conductivity + ' mS/cm'} />
                    <Parameters parameterName="Turbidity(NTU)" value={dummyData[1].Turbidity} />
                ...
                <Grid container alignItems="center" spacing={6}>  {/* GRAPHS and MAP*/}
                    <Grid item sm={7}> {/* GRAPHS*/}
                        <h3>pH</h3>
                        <h6>(Scale 0-14)</h6>
                    ...
                    <Grid item sm={5} alignItems="flex=end" justifyContent="flex=end" > {/* MAP*/}
                        <MapContainer center={[33.711199, 73.130]} zoom={13} scrollWheelZoom={true}>
                            <TileLayer
                                attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
                                url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                            />
                            <Marker position={[33.711199, 73.130]}>
                                <Popup>
